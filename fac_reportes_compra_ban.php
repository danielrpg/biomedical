...
<div id="pagina_sistema">
     <ul id="lista_menu">      
				 ...
				 <li id="menu_modulo_fecha">
                     ...
                     <img src="img/compra_24x24.png" border="0" alt="Modulo" align="absmiddle"> REP.COMPRA BANC.
...
//$resultado = mysql_query($consulta)or die('No pudo seleccionarse tabla')  ;
 ...
 <div id="menu_lista">
                      ...
                      <h2> <img src="img/documents_64x64.png" border="0" alt="Modulo" align="absmiddle"> REPORTES COMPRA BANCARIZACION</h2>
                      <hr style="border:1px dashed #767676;">
                       <!--div id="error_login"> 
          <img src="img/alert_32x32.png" align="absmiddle">
        Reportes / Compra </div-->
                        <div class="menu_item">
                                <a href="fac_rep_op.php?accion=41"> 
                                    <img src="img/edit file_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                    Compras Bancarizacion
                                </a>
    </div>
                         <div class="menu_item">
                                <a href="fac_rep_op.php?accion=42"> 
                                    <img src="img/find_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                    Compras Bancarizacion Por Rangos
                                </a>
                         </div>
                         <div class="menu_item">
                                <a href="fac_rep_op.php?accion=43"> 
                                    <img src="img/documents_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                    Compras Bancarizacion (Texto)
                                </a>
                         </div>
