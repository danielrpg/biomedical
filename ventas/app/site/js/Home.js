...
function Home(){
      ...
      $.ajax({
        ...
        success: function(resultado){
            ...
            $('#tpl_vent_form_nuevo_cot_det_priv').empty();
                ...
                tabla_cabecera = tabla_cabecera+'<tr><th>TIPO</th><th>PRODUCTO</th><th>CANTIDAD</th><th>P. VENTA</th><th>SERVICIO</th><th>TOTAL</th><th>PROCEDENCIA</th><th>TIEMPO ESPERA</th><th>CATALOGO</th><th>ESPECIFICACIONES TEC.</th><th>CONF. DESEADA</th><th>ACCESORIOS</th><th>SERV. NECESARIO</th></tr>';
              //tabla_cabecera = tabla_cabecera+'<tr><th>TIPO</th><th>PRODUCTO</th><th>CANTIDAD</th><th>P. VENTA</th><th>TOTAL</th><th>PROCEDENCIA</th><th>TIEMPO ESPERA</th><th>CATALOGO</th><th>ESPECIFICACIONES TEC.</th><th>CONF. DESEADA</th><th>ACCESORIOS</th><th>SERV. NECESARIO</th><th>MODIFICAR</th><th>ELIMINAR</th></tr>';
                $.ajax({
                  url:'index.php',
                  dataType: 'json',
                  type: 'GET',
                    ...
                    //console.log(resultado2);
                     ...
                     if(resultado2 != null){
                        ...
                        $.each(resultado2, function(index, value2){ 
                          ...
                          porc_serv = porc_serv+((value2.vent_prof_det_porc_serv_prof*value.vent_prof_det_cant_prod)*100);
                          ...
                          total_totales = total_totales + (value2.vent_prof_det_cant_prod*value2.vent_prof_det_precio_venta)+((value2.vent_prof_det_porc_serv_prof*value2.vent_prof_det_cant_prod)*100);;
                          tabla_cabecera = tabla_cabecera +'<td align="center">'+(value2.vent_prof_det_porc_serv_prof*value2.vent_prof_det_cant_prod)+'</td>';
                          tabla_cabecera = tabla_cabecera +'<td align="center">'+((value2.vent_prof_det_cant_prod*value2.vent_prof_det_precio_venta)+((value2.vent_prof_det_porc_serv_prof*value2.vent_prof_det_cant_prod)*100))+'</td>';
                        ...
                        tabla_cabecera = tabla_cabecera +'<td align="center"><strong>'+porc_serv+'</strong></td>';
  ...
  this.listarDetalleCotizacionPrivada02 = function(codigo_prof_venta_01){
     ...
     // console.log(codigo_prof_venta_01);
      ...
      $.getJSON('index.php', {action:'cotizaciones', tp:'getDetallePriv', id_prof:codigo_prof_venta_01}, function(json, textStatus) {
        ...
        tabla_cabecera = tabla_cabecera+'<tr><th>TIPO</th><th>PRODUCTO</th><th>CANTIDAD</th><th>P. VENTA</th><th>SERVICIO</th><th>TOTAL</th><th>PROCEDENCIA</th><th>TIEMPO ESPERA</th><th>CATALOGO</th><th>ESPECIFICACIONES TEC.</th><th>CONF. DESEADA</th><th>ACCESORIOS</th><th>SERV. NECESARIO</th><th>MODIFICAR</th><th>ELIMINAR</th></tr>';
        ...
        $.each(json, function(index, value) {
          ...
          porc_serv = porc_serv+((value.vent_prof_det_porc_serv_prof*value.vent_prof_det_cant_prod)*100);
          total_totales02 = total_totales02 + (value.vent_prof_det_cant_prod*value.vent_prof_det_precio_venta)+((value.vent_prof_det_porc_serv_prof*value.vent_prof_det_cant_prod)*100);
          tabla_cabecera = tabla_cabecera +'<td align="center">'+(value.vent_prof_det_porc_serv_prof*value.vent_prof_det_cant_prod)+'</td>';
          tabla_cabecera = tabla_cabecera +'<td align="center">'+((value.vent_prof_det_cant_prod*value.vent_prof_det_precio_venta)+((value.vent_prof_det_porc_serv_prof*value.vent_prof_det_cant_prod)*100))+'</td>';
          ...
          tabla_cabecera = tabla_cabecera +'<td align="center"><a href="#" onclick="new Home().modificarDatosProductoProf(\''+value.vent_prof_det_cod_unico+'\',\''+codigo_prof_venta_01+'\')"><img src="../img/edit_prod_32x32.png" align="absmiddle"><br>Modificar</a></td>';
   ...
   **/
  this.modificarDatosProductoProf = function(codigo_unico_prof_venta, codigo_prof_cabecera){
    $.getJSON('index.php', {action:'cotizaciones',tp:'getDetalleProductoEspecif', codigo_unico:codigo_unico_prof_venta}, function(res){
        //console.log(res.id_codigo_unico_det);
        $("#dialog-confirm-cot").attr("title", "Modificar Datos Producto");
        $("#dialog-confirm-cot #contexto_dialog_cot").empty();
        contexto_dialog = '<h3><img src="../img/edit_prod_32x32.png" align="absmiddle"> Modificar Datos de Producto</h3><hr>';
        contexto_dialog = contexto_dialog+'<form id="id_form_prof_venta_000545">';
        contexto_dialog = contexto_dialog+'<input type="hidden" name="codigo_prof_cabecera0021" id="codigo_prof_cabecera0021" value="'+codigo_prof_cabecera+'">';
        contexto_dialog = contexto_dialog+ '<table border="0">';
        contexto_dialog = contexto_dialog+'<tr><td><strong>P.MAX VENTA</strong></td><td><input type="hidden" id="codigo_unico_preventa_prf" name="codigo_unico_preventa_prf" value="'+res.id_codigo_unico_det+'"><input type="text" id="prec_max_det_prod_01" name="prec_max_det_prod_01" value="'+res.precio_venta_max_det_prod+'" readonly></td></tr>';
        contexto_dialog = contexto_dialog+'<tr><td><strong>P.MIN VENTA</strong></td><td><input type="text" name="prec_min_det_prod_01" id="prec_min_det_prod_01" value="'+res.precio_venta_min_det_prod+'" readonly></td></tr>';
        contexto_dialog = contexto_dialog+'<tr><td><strong>VENTA</strong></td><td><input type="text" name="venta_nueva_preventa_prod" id="venta_nueva_preventa_prod" value="'+res.vent_precio_venta_prof+'" class="txt_campo"></td></tr>';
        contexto_dialog = contexto_dialog+'<tr><td><strong>CANTIDAD</strong></td><td><input type="text" id="cantidad_prof_nueva_text" name="cantidad_prof_nueva_text" value="'+res.cantidad_vent_prof_prod+'" class="txt_campo"></td></tr>';
        contexto_dialog = contexto_dialog+'<tr><td><input type="submit" value="GUARDAR DETALLE" class="btn_form"></td><td><input type="button" value="CANCELAR"  class="btn_form" onClick="new Home().cancelarModifVentaProd();"></td></tr>';
        contexto_dialog = contexto_dialog + '</table></form>'
        $("#dialog-confirm-cot #contexto_dialog_cot").append(contexto_dialog);
        $('#venta_nueva_preventa_prod').numeric('.');
        $('#cantidad_prof_nueva_text').numeric();
        new Home().procesarFormularioProfVentaModif();
        $("#dialog-confirm-cot").dialog({
          resizable: false,
          height:300,
          width:500,
  ...
  /** Metodo que permite procesar el formulario de modificacion de datos **/
  this.procesarFormularioProfVentaModif = function(){
    var util = new Utilitarios();
    $('#id_form_prof_venta_000545').submit(function(evt){
      //alert($(this).serialize());
      if($('#venta_nueva_preventa_prod').val() == ""){
  ...
  /** Este es metodo que permite cancelar o cerrar la ventana **/
  this.cancelarModifVentaProd = function(){
    $('#dialog-confirm-cot').dialog('close');
  }
  /**
  ...
  this.anadirProductoPropuesta = function(codigo_producto_cab, codigo_producto_det, codido_prof_unico){
      ...
      $.getJSON('?action=cotizaciones&tp=getProductoInformation&codigo_cab='+codigo_producto_cab+'&codigo_det='+codigo_producto_det, function(result){
          ...
          $('#txt_vent_codigo_unico').val(codigo_producto_det);
        ...
        $.ajax({
          ...
          success:function(res){
            ...
            if(res.complet){
              ...
              $('#txt_vent_cotizador_proforma').val(nom_cliente+' '+app_cliente+' '+appm_cliente);
