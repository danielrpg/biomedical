...
//$datos = $_SESSION['form_buffer'];
 ...
 <table align="center">
	    ...
	    <td><input class="txt_campo" type="text" name="cod_orden" id="cod_orden" size="15" maxlength="15" onKeyPress="return soloNum(event)" onBlur="limpia()" > 
		<div id="error_cod_orden"></div></td>
	    </tr>
		 <tr>
        <th align="left">Nro. Factura Desde:</th>
	    <td><input class="txt_campo" type="text" name="nro_fac_des" id="nro_fac_des" size="10" maxlength="10"  onkeypress="return soloNum(event)" onBlur="limpia()"> 
		<div id="error_nro_fac_des"></div></td>
		 </tr> 
		 <tr>
	    <tr>
              <th align="left" >Nro. Factura Hasta:</th>
              <td><input class="txt_campo" type="text" name="nro_fac_has" id="nro_fac_has" size="10" maxlength="10"  onkeypress="return soloNum(event)" onBlur="limpia()">
        ...
        <td><input class="txt_campo" type="muneric" name="cantidad" id="cantidad" maxlength="10"  size="10" onkeypress="return soloNum(event)" onBlur="limpia()"> 
