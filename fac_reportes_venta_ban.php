...
// Se realiza una consulta SQL a tabla gral_param_propios
 ...
 <div id="menu_lista">
                      ...
                      <h2> <img src="img/documents_64x64.png" border="0" alt="Modulo" align="absmiddle"> VENTAS BANCARIZACION</h2>
                      <hr style="border:1px dashed #767676;">
                       <!--div id="error_login"> 
          <img src="img/alert_32x32.png" align="absmiddle">
            Reportes / Venta </div-->
                        <div class="menu_item">
                                <a href="fac_rep_op.php?accion=31"> 
                                    <img src="img/edit file_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                     Ventas Bancarizacion
                                </a>
                         </div>
                         <div class="menu_item">
                                <a href="fac_rep_op.php?accion=32"> 
                                    <img src="img/find_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                    Ventas Bancarizacion Por Rangos
                                </a>
                         </div>
                         <div class="menu_item">
                                <a href="fac_rep_op.php?accion=33"> 
                                    <img src="img/documents_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                    Ventas Bancarizacion (Texto)
                                </a>
                         </div>
