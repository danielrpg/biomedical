...
<body>
 ...
 <div id="div_impresora" class="div_impresora" style="width:860px" align="right">
       <a href="javascript:print();">Imprimir</a>
	    ...
	    <a href='con_retro.php?accion=34'>Salir</a>
	    <?php } elseif($_SESSION['menu']==4){?> 
	    <a href='con_retro.php?accion=35'>Salir</a>
...
<br><br>
<?php
echo " AITB Cuentas de Ingreso con UFV";
?>
<br><br>
</font>
<?php
 ...
 $consulta = "insert into gral_tipo_cambio (GRAL_TIP_CAM_AGEN, 
									        ...
									        GRAL_TIP_CAM_FCH_BAJA 
												 ...
												 '$log_usr',
												  ...
												  null,
												  '0000-00-00 00:00:00')";
$resultado = mysql_query($consulta)or die('No pudo insertar gral_tipo_cambio 30: ' . mysql_error());	   
 $consulta = "insert into gral_tipo_cambio (GRAL_TIP_CAM_AGEN, 
                                            GRAL_TIP_CAM_MONEDA,
									        GRAL_TIP_CAM_CONTAB,
									        GRAL_TIP_CAM_OFICIAL,
									        ...
									        GRAL_TIP_CAM_FCH_BAJA 
												 ...
												 '$log_usr',
												  ...
												  null,
												  '0000-00-00 00:00:00')";
$resultado = mysql_query($consulta)or die('No pudo insertar gral_tipo_cambio 32: ' . mysql_error());	   
