...
<html>
<head>
<title>Crea Mesa Directiva Grupo</title>
...
$total = 0;
 ...
 <?php 
 $gru = "0"; 
$con_car  = "Select * From cart_maestro where CART_ESTADO < 8 and CART_COD_GRUPO <> 0 and CART_MAE_USR_BAJA is null group by 6 "; 
