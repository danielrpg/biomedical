...
//Actualiza nuevo monto deuda y la comision
  ...
  $res_deu = mysql_query($con_deu)or die('No pudo seleccionarse tabla cred_deudor');
  $imp_cap = 0;
  $imp_com = 0;
 while ($lin_deu = mysql_fetch_array($res_deu)) {
    $imp_cap = $imp_cap + $lin_deu['CRED_DEU_IMPORTE'];
	$imp_com = $imp_com + $lin_deu['CRED_DEU_COMISION'];
    } 
$act_sol  = "update cred_solicitud set CRED_SOL_IMPORTE =$imp_cap,CRED_SOL_IMP_COM = $imp_com  where CRED_SOL_CODIGO = $cod_sol and CRED_SOL_USR_BAJA is null"; 
$res_sol = mysql_query($act_sol)or die('No pudo actualizar cred_solicitud' );	
//Seleccion solicitud
...
?>
<tr>
        <td align="center"><?php echo encadenar(3); ?></td>
...
<input type="submit" name="accion" value="Salir">
 ...
 <div id="FooterTable">
<BR><B><FONT SIZE=+2><MARQUEE>Impresion Orden de Desembolso</MARQUEE></FONT></B>
</div>
   <?php
