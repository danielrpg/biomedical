...
<title>Impresion Plan de Pagos</title>
<meta charset="UTF-8">
...
<div id="pagina_sistema">
        ...
        <ul id="lista_menu">      
                 ...
                 <li id="menu_modulo_creditos">
                  ...
                  <li id="menu_modulo_creditos_pagos">
                   ...
                   <li id="menu_modulo_fecha">
                     ...
                     <img src="img/directories_32x32.png" border="0" alt="Modulo" align="absmiddle">PLAN DE PAGOS
                    
                 </li>
              </ul>  
              <div id="contenido_modulo">
<h2> <img src="img/directories_64x64.png" border="0" alt="Modulo" align="absmiddle"><strong>PLAN DE PAGOS </strong> </h2>
...
$con_sol = "Select * From cred_solicitud where CRED_SOL_ESTADO > 4 and CRED_SOL_ESTADO < 8 and
...
?>
  ...
  <input class="btn_form" type="submit" name="accion" value="Impresion Plan Pagos">
  <input class="btn_form" type="submit" name="accion" value="Salir">
  </form>
 <BR><B><FONT SIZE=+2><MARQUEE></MARQUEE></FONT></B>
</body>
</html>
 <?php
