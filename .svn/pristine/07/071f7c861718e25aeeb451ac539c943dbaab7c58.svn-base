...
<!--Menu izquierdo de los modulos-->
     <ul id="lista_menu">      
                 ...
                 <li id="menu_modulo_cajachica">
                  ...
                  <li id="menu_modulo_cajachica_liquidacion">
                     ...
                     <img src="img/refresh_24x24.png" border="0" alt="Modulo" align="absmiddle"> REPOSIC.CAJA CHICA
 ...
 <div id="contenido_modulo">
                      <h2> <img src="img/refresh_64x64.png" border="0" alt="Modulo" 
					  align="absmiddle">REPOSICION CAJA CHICA</h2>
                      <hr style="border:1px dashed #767676;">
                      <div id="error_login"> 
                     <img src="img/checkmark_32x32.png" align="absmiddle">
                     Elija la Caja Chica para pedir la reposicion
                     </div>
...
?>
  ...
  <input class="btn_form" type="submit" name="accion" value="Reposicion">
  <!--input class="btn_form" type="submit" name="accion" value="Salir"-->
  </form>
