...
<?php if ($_SESSION["tip_rep"] == 41){?>
 ...
 <?php } if ($_SESSION["tip_rep"] == 42) { ?>
 	   <a href='con_factura.php?menu=12'>Salir</a>
<?php } ?>
...
<?php 
  //Datos del cart_det_tran	
   // echo $f_des2.encadenar(2).$f_has2;
	...
	if ($_SESSION["tip_rep"] == 42) {				
	$con_tpa = "Select * From fac_bancari where FAC_BAN_FECHA between '$f_des2' and '$f_has2' and FAC_BAN_TIPO = 1
	            order by FAC_BAN_FECHA,FAC_BAN_NRO";
	}			
