...
if ($_SESSION['detalle'] == 1){
    ...
    $resultado = mysql_query($consulta)or die('No pudo insertar temp_ctable 1 : ' . mysql_error());
          ...
          <tr>
	     <th align="left"><?php echo $cuenta; ?></th>
		 <th align="left"><?php echo "CArtera"; ?></th>
		 <td align="right"  ><?php echo number_format(0, 2, '.',','); ?></td> 
		 <td align="right"  ><?php echo number_format($monto2, 2, '.',','); ?></td> 
		 <td align="right"  ><?php echo number_format(0, 2, '.',','); ?></td> 
		  <td align="right"  ><?php echo number_format($mon_eqv, 2, '.',','); ?></td>  
	  </tr>
	<?php } ?>
	<?php 
	 $con_cart  = "select  CART_DTRA_CTA_CBT, sum(CART_DTRA_IMPO), sum(CART_DTRA_IMPO_BS) from cart_det_tran 
	...
	<tr>
	     <th align="left"><?php echo $cuenta; ?></th>
		 <th align="left"><?php echo "Fondo"; ?></th>
		 <td align="right"  ><?php echo number_format($monto2, 2, '.',','); ?></td> 
		 <td align="right"  ><?php echo number_format(0, 2, '.',','); ?></td> 
		 <td align="right"  ><?php echo number_format($mon_eqv, 2, '.',','); ?></td> 
		  <td align="right"  ><?php echo number_format(0, 2, '.',','); ?></td>  
	...
	$con_ingegr  = "select caja_ingegr_cta, sum(caja_ingegr_impo),sum(caja_ingegr_impo_e)  from caja_ing_egre
	              ...
	              and caja_ingegr_tipo = 2 group by caja_ingegr_cta";
	...
	<tr>
	     <th align="left"><?php echo $cuenta; ?></th>
		 <th align="left"><?php echo "ing_egre"; ?></th>
		 <td align="right"  ><?php echo number_format($monto2, 2, '.',','); ?></td> 
		 <td align="right"  ><?php echo number_format(0, 2, '.',','); ?></td> 
		 <td align="right"  ><?php echo number_format($mon_eqv, 2, '.',','); ?></td> 
		  <td align="right"  ><?php echo number_format(0, 2, '.',','); ?></td>  
	...
	<tr>
	     <th align="left"><?php echo $cuenta; ?></th>
		 <th align="left"><?php echo "Compra Venta"; ?></th>
		 <td align="right"  ><?php echo number_format($monto2, 2, '.',','); ?></td> 
		 <td align="right"  ><?php echo number_format(0, 2, '.',','); ?></td> 
		 <td align="right"  ><?php echo number_format($mon_eqv, 2, '.',','); ?></td> 
		  <td align="right"  ><?php echo number_format(0, 2, '.',','); ?></td>  
