	     ...
	     <ul id="lista_menu">      
                 ...
                 <li id="menu_modulo_contabilidad">
                  ...
                  <li id="menu_modulo_fecha">
                     ...
                     <img src="img/users group_24x24.png" border="0" alt="Modulo" align="absmiddle"> MAYOR RANGO CTA.
              ...
              <div id="contenido_modulo">
                      ...
                      <h2> <img src="img/users group_64x64.png" border="0" alt="Modulo" align="absmiddle"> MAYOR RANGO DE CUENTAS</h2>

                      <hr style="border:1px dashed #767676;">
                       <div id="error_login"> 
                          <img src="img/checkmark_32x32.png" align="absmiddle">
                          Ingrese la fecha de c&aacute;lculo de la gesti&oacute;n para ver Mayor Rango de Cuentas.
                      </div>
...
if ($_SESSION['continuar'] == 1){
    ...
    $res_ctas = mysql_query($con_ctas);
	 $con_cta2  = "Select * From contab_cuenta where CONTA_CTA_NIVEL = 'A'";
    $res_cta2 = mysql_query($con_cta2);
	...
	<!--  <tr>
			 <th align="left">Cuenta Contable Desde:</th>
	  <td> <select name="cod_cta" size="1" style="width:400px;"  >
	...
	<!-- <tr>
			 <th align="left">Cuenta Contable Hasta :</th>
	  <td> <select name="cod_cta2" size="1"  style="width:400px;">
	  
	       <?php //while ($lin_cta2 = mysql_fetch_array($res_cta2)) { ?>
           <option value=<?php //echo $lin_cta2['CONTA_CTA_NRO']; ?>>
		                 <?php //echo $lin_cta2['CONTA_CTA_NRO']; ?>
			              <?php //echo utf8_encode($lin_cta2['CONTA_CTA_DESC']); ?></option>
           <?php //} ?>
		    </select></td>
    </tr> -->
	<tr>
				 <th align="left">Cuenta Contable Hasta:</th>
				 <td><input class="txt_campo_cta" type="text" name="cuenta_busca_datos2" id="cuenta_busca_datos2"/>
                                            <input class="txt_campo" type="hidden" name="cod_cta2" id="cod_cta2" /></td>
				 </tr>
			  <BR><br>	 
...
//if ($_SESSION['tipo'] == 2) {
 ...
 //}	  
	...
	<?php
	echo encadenar(15).
	    encadenar(2)."de".encadenar(2).$_SESSION['cod_cta'].
 ...
 <table width="100%"  border="0" align="center">
	...
	<?php
	 ...
	 <input class="btn_form" type="submit" name="accion" value="Imp_Mayor">
