...
<?php
echo encadenar(20)."Detalle de Cartera  al ".encadenar(2).$fec_pro.encadenar(2).
     "Asesor" . encadenar(2).$nomb_ase;
?>
</font>
<br><br>
<?php
...
$con_car  = "Select * From cart_maestro, cart_deudor, cliente_general
			 ...
			 and (CART_OFIC_RESP = '$cod_ase' or CART_OFIC_RESP = '$log_ase')
