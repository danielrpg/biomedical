...
if(isset($_POST['fec_nac'])){
 ...
 $con_emp = "Select *  From gral_empresa ";
	...
	$arch = "D:/xampp/htdocs/Trebol/ArchivoTXT/"."Compras_".$mes.$anio."_".$emp_nit.".txt";
...
<?php 
   // $arch = "c:\reportes\".$arch;
	...
	$t_neto = 0;
	$t_debito = 0; 
	if ($_SESSION["tip_rep"] == 27) {				
	$con_tpa = "Select * From factura where month(FACTURA_FECHA) = '$mes' and year(FACTURA_FECHA) =  '$anio' and FACTURA_TIPO = 1
