     ...
     <div id="contenido_modulo">
                ...
                <?php }elseif ($_GET["menu"]==5) { $parm=5;?>
                  <li id="menu_modulo_fecha">
                     ...
                     <img src="img/bancos_24x24.png" border="0" alt="Modulo" align="absmiddle"> DET. MOV. BANCOS
                    
                 </li>
              </ul> 
<!--Cabecera del modulo con su alerta-->
     <div id="contenido_modulo">
                      <h2> <img src="img/bancos_64x64.png" border="0" alt="Modulo" align="absmiddle">DETALLE MOVIMIENTOS BANCOS</h2>
                      <hr style="border:1px dashed #767676;">
                      <div id="error_login"> 
                     <img src="img/checkmark_32x32.png" align="absmiddle">
                ...
                <?php }elseif ($_GET["menu"]==6) {$parm=6; ?>
                  <li id="menu_modulo_fecha">
                     ...
                     <img src="img/label_24x24.png" border="0" alt="Modulo" align="absmiddle"> DET. MOV. VALES
...
<!--Cabecera del modulo con su alerta-->
     <div id="contenido_modulo">
                     ...
                     <div id="error_login"> 
                     <img src="img/checkmark_32x32.png" align="absmiddle">
                     Ingrese los datos para generar el reporte Detalle Mov. Vales.
                     </div>  
