...
$(document).on('ready', function(){
	...
	//modulo reportes fondo
	$('#menu_modulo_mant_cuenta_incor').click(function(){
		$(location).attr('href', 'cliente_con_solic.php');
	});
	//modulo reportes fondo
	$('#menu_modulo_mant_cuenta_incor_impr').click(function(){
		$(location).attr('href', 'cliente_con_sol.php');
	});
});