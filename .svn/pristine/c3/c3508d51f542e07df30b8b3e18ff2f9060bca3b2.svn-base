...
$(document).on('ready', function(){
	...
	$('#menu_modulo_contabilidad_asientocontable_util_res_rev').click(function(){
		$(location).attr('href', 'con_retro.php?accion=9');
	});
	$('#menu_modulo_contabilidad_asientocontable_consultar').click(function(){
		$(location).attr('href', 'con_retro.php?accion=2');
	});
	$('#menu_modulo_contabilidad_asientocontable_consultar_sel').click(function(){
		$(location).attr('href', 'con_retro.php?accion=2');
	});
	$('#menu_modulo_contabilidad_asientocontable_consultar_sel_modif').click(function(){
		$(location).attr('href', 'con_retro.php?accion=2');
	});
	$('#menu_modulo_contabilidad_asientocontable_consultar_sel_modif_rev').click(function(){
		$(location).attr('href', 'con_retro.php?accion=2');
	});
