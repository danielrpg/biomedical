...
<title>Reporte Recibos Utilizados</title>
<meta charset="UTF-8">
...
<div id="pagina_sistema">
        ...
        <ul id="lista_menu">      
                 ...
                 <li id="menu_modulo_contabilidad_recibos_reportes">
                     ...
                     <img src="img/windows folder_24x24.png" border="0" alt="Modulo" align="absmiddle"> RECIBOS UTILIZADOS
                    
                 </li>
              </ul>  
              <div id="contenido_modulo">
<h2> <img src="img/windows folder_64x64.png" border="0" alt="Modulo" align="absmiddle"> RECIBOS UTILIZADOS </h2>
  ...
  <form name="form2" method="post" action="con_retro_1.php" onSubmit="return validarBotonRadio(this);">
...
<table border="0" width="200" align="center" class="table_usuario">
	<br>
	<tr>
...
<center>
    <?php //} ?> <br>
		 <input class="btn_form" type="submit" name="accion" value="Recibos Utilizados" >
...
$_SESSION['nro_tal'] = $nro_tal;
 header('Location: rep_rec_uti.php');
    } 
$cuan_1 = 0;
...
$cuan_2 = 0;
	  ...
	  $con_rec = "Select * 
	  			  From recibo_cntrl where REC_CTRL_NRO = $nro_tal and
