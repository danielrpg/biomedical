...
<script language="javascript" src="script/validarForm.js"></script> 
 <script type="text/javascript" src="js/Alm_prov.js"></script>  
...
<!--Cabecera del modulo con su alerta-->
          <div id="menu_lista">
                      ...
                      <h2> <img src="img/provider_64x64.png" border="0" alt="Modulo" align="absmiddle"> PROVEEDORES</h2>
          ...
          <img src="img/alert_32x32.png" align="absmiddle">
            Alta, Consulta, Modificaci&oacute;n, Habilitaci&oacute;n / Inhabilitaci&oacute;n de proveedores
                        ...
                        <div class="menu_item">
                                <a href="alm_proveedor_mod.php?accion=1"> 
                                    <img src="img/provider_agregar_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                    Alta
                                </a>
                         </div>
                         <div class="menu_item">
                                <a href="alm_proveedor_mod.php?accion=2"> 
                                    <img src="img/provider_search_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                    Consultar
                                </a>
                         </div>
