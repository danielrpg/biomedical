...
<!--Menu izquierdo de los modulos-->
 ...
 <div id="contenido_modulo">
                      <h2> <img src="img/export_64x64.png" border="0" alt="Modulo" 
					  align="absmiddle">REPOSICION CAJA CHICA</h2>
                      <hr style="border:1px dashed #767676;">
                      <div id="error_login"> 
                     <img src="img/checkmark_32x32.png" align="absmiddle">
                     Elija la Caja Chica para hacer la reposicion
                     </div>
...
?>
<strong>Caja(s) Chica(s) con Solicitud de Reposicion </strong>
<?php
  // echo $linea['GRAL_PAR_PRO_DESC'];
  // }
  ?> 
 <?php
$con_sol = "Select * From cjach_cntrl where CJCH_CTRL_ESTADO = 2 
...
?>
  ...
  <input class="btn_form" type="submit" name="accion" value="Reponer Caja Chica">
  <!--input class="btn_form" type="submit" name="accion" value="Salir"-->
  </form>
