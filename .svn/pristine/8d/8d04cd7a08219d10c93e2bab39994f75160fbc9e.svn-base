...
<!--Menu izquierdo de los modulos-->
 ...
 <div id="contenido_modulo">
                      <h2> <img src="img/open document_64x64.png" border="0" alt="Modulo" 
					  align="absmiddle">LIQUIDACION CAJA CHICA</h2>
                      <hr style="border:1px dashed #767676;">
                      <div id="error_login"> 
                     <img src="img/checkmark_32x32.png" align="absmiddle">
                     Elija la Caja Chica para hacer la liquidacion
                     </div>
...
?>
  ...
  <input class="btn_form" type="submit" name="accion" value="Liquidar">
  <!--input class="btn_form" type="submit" name="accion" value="Salir"-->
  </form>
