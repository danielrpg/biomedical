...
<!--script type="text/javascript" src="js/contabilidad_reportes_eerr_bal.js"></script--> 
...
<div id="contenido_modulo">
                      ...
                      <h2> <img src="img/delete user_64x64.png" border="0" alt="Modulo" align="absmiddle"> ELIMINA CUENTA</h2>
                      <hr style="border:1px dashed #767676;">
                       <div id="error_login"> 
          <img src="img/checkmark_32x32.png" align="absmiddle">
          Seleccione la Cuenta Contable que se desea eliminar
        </div>
        <?php }elseif ($_GET["menu"]==10) { ?>

        <li id="menu_modulo_cont_reportes">
                    
                     <img src="img/documents_24x24.png" border="0" alt="Modulo" align="absmiddle"> CONTB. REPORTES
                    
                 </li>
                  <li id="menu_modulo_fecha">
                    
                     <img src="img/edit file_24x24.png" border="0" alt="Modulo" align="absmiddle"> EERR (BALANCE)
...
<div id="contenido_modulo">
                      ...
                      <h2> <img src="img/edit file_64x64.png" border="0" alt="Modulo" align="absmiddle"> ESTADO DE RESULTADOS (BALANCE)</h2>
                      <hr style="border:1px dashed #767676;">
                       <!--div id="error_login"> 
...
if ($_SESSION['detalle'] == 1){ ?>
    <form name="form2" method="post" action="eli_plancta.php?menu=1" onSubmit="return checkCtas(this)">
<?php	
    ...
    <?php /*if ($_SESSION['continuar'] == 1){?>
      <tr>
		 ...
		 <td><input type= type="text" name="descrip" size="70" maxlength="70"  > </td>
	  </tr>
	<?php } */ ?>
	...
	<center>
	 ...
	 <center>	
		 <input class="btn_form" type="submit" name="accion" value="Seleccionar Cta.">
