	...
	<div id="pagina_sistema">
            ...
            <ul id="lista_menu">      
                 ...
                 <li id="menu_modulo_general_importaciones">
                    <img src="img/box_32x32.png" border="0" alt="Modulo" align="absmiddle"> MOD. IMPORTACIONES
                          
                 </li>
                  <li id="menu_modulo_general_importaciones_gestion">
                    <img src="img/agencia_32x32.png" border="0" alt="Modulo" align="absmiddle"> GES. IMPORTACIONES
                 </li>
              </ul>
              <li id="menu_modulo_general_importaciones_contrato">
            ...
            <tr>
              ...
              <tr>
                <td><strong>Tipo :</strong></td> 
                        <?php
                             $cons_tipo = "Select GRAL_PAR_PRO_ID, GRAL_PAR_PRO_DESC 
                ...
                <td> <select name="tipo" size="1" size="10" id="tipo">
                       <?php
                        ...
                        ?>
                              <option value=<?php echo utf8_encode($linea['GRAL_PAR_PRO_ID']); ?>>
              ...
              <tr>
               ...
               <td><input  class="txt_campo" name="nro_doc" id="nro_doc" cols="50" rows="2"><div id="error_desc"></div>
               </td>
            </tr>
           <tr>
