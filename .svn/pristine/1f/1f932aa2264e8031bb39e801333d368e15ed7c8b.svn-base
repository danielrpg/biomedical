...
$(document).on('ready', function(){
	...
	//modulo reportes fondo
	$('#menu_modulo_cajas_reim_fg').click(function(){
		$(location).attr('href', 'cja_rimp_par.php?menu=11');
	});
	//modulo reportes fondo
	$('#menu_modulo_cajas_reim_fg_sel').click(function(){
		$(location).attr('href', 'cja_rrev_fga.php');
	});
});