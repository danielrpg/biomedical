...
//$resultado = mysql_query($consulta)or die('No pudo seleccionarse tabla')  ;
 ...
 <div id="menu_lista">
          ...
          <img src="img/alert_32x32.png" align="absmiddle">
            Reporte / Facturaci&oacute;n
        </div-->
                        
                         <div class="menu_item">
                                <a href="fac_reportes_venta.php"> 
                                    <img src="img/venta_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                    Ventas
                                </a>
                         </div>
                         <div class="menu_item">
                                <a href="fac_reportes_compra.php"> 
                                    <img src="img/compra_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                                    Compras
                                </a>
                         </div>
                          <div class="menu_item">
                                <a href="fac_reportes_venta_ban.php"> 
                                    <img src="img/venta_64x64.png">
                                    <hr style="border:1px dashed #767676;">
                         ...
                         <div class="menu_item">
                                <a href="fac_reportes_compra_ban.php"> 
                                    <img src="img/compra_64x64.png">
                                    <hr style="border:1px dashed #767676;">
