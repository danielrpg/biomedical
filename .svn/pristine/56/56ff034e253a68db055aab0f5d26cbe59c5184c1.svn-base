...
<body>
 ...
 <div id="div_impresora" class="div_impresora" style="width:860px" align="right">
       <a href="javascript:print();">Imprimir</a>
	    ...
	    <a href='egre_retro.php?accion=5'>Salir</a>
	    <?php } elseif($_SESSION['menu']==2){?>
	    <a href='egre_retro.php?accion=6'>Salir</a>
	    <?php }?> 
  </div>
...
echo encadenar(5)."Recibo de".encadenar(1).$_SESSION['des_tran'].encadenar(45)."Recibo de".encadenar(1).$_SESSION['des_tran']; 
?>
</font></strong>
</center>
...
?>
 <table border="0" width="900">  
    ...
    <tr>
	    <th align="left" style="font-size:11px"><?php echo $_SESSION['MON_AGENCIA'].encadenar(2).$fecha.encadenar(2).$hora?></th>
		 <th align="left"><?php echo encadenar(40); ?> </th>  
		 <th align="left" style="font-size:11px"><?php echo $_SESSION['MON_AGENCIA'].encadenar(2).$fecha.encadenar(2).$hora?></th>
   </tr>
</table>
 ...
 <table border="0" width="450">  
    ...
    <tr>
	    <th align="left" style="font-size:11px"><?php echo "Antes de firmar verifique los datos".
		                                              encadenar(55)."Cochabamba".encadenar(1).$fecha.encadenar(1).$hora?></th>
		<th align="left"><?php echo encadenar(20); ?> </th>  
