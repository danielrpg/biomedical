...
if ($_SESSION['continuar'] == 2){
	 $con_emp = "Select GRAL_EMP_NOMBRE  From gral_empresa ";
	   ...
	   <a href='cont_rep_op.php?accion=7'>Salir</a>
	   <?php } elseif($_SESSION['menu'] == 49){?> 
	   <a href='cont_rep_op.php?accion=29'>Salir</a>
	   <?php }?>
	  </center> 
	 <br> 
	   <?php
...
?>	
	    <font size="+2">
	<?php	  
	echo encadenar(15). "Detalle Movimientos Cuenta".encadenar(2);
	...
	<?php   if ($cuenta1 <> ""){ ?>
		...
		<tr></tr>   
		 <tr>
			 ...
			 <?php echo number_format($sal_1 , 2, '.',','); ?></td>
			 ...
			 <th align="right" style="font-size:12px">
			 <?php echo number_format( $sal_2 , 2, '.',','); ?></td>
	...
	<tr>
	 <td align="left" style="font-size:12px"><?php echo encadenar(4); ?></td>
	   <td align="right" style="font-size:12px"><?php echo encadenar(5); ?></td> 
		...
		<td align="left" style="font-size:12px"><?php echo "Saldo inicial al ".$fec_des; ?></td>
