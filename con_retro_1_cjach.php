...
switch( $_POST['accion'] ) {
      case "Salir":
	   ...
	   case "Seleccionar":
	       ...
	       break;
		 case "Registrar Parametros":
	      // echo "aqui detalle 34";
	     //  $_SESSION['continuar'] = 3;
	       $_SESSION['detalle'] = 3;
	      // $_SESSION['menu'] = 2;
		   //$_SESSION['continuar'] = 2;
		   require 'alt_caja_chica.php';
	       break;   
      case "Registrar Gasto Caja Chica":
	  ...
	  case "Grabar":
	   ...
	   case "Liquidar":
	    ...
	    //   $_SESSION['menu'] = 7;
		   //$_SESSION['continuar'] = 2;
		  require 'cjach_liquidacion.php';
		  break;	
	   case "Imprimir Liquidacion":
	      // echo "aqui detalle 34";
	     //  $_SESSION['continuar'] = 3;
	       $_SESSION['detalle'] = 3;
	    //   $_SESSION['menu'] = 7;
		   //$_SESSION['continuar'] = 2;
		  require 'cjach_liqui_imp.php';
	    ...
	    //   $_SESSION['menu'] = 7;
		   //$_SESSION['continuar'] = 2;
		  require 'cjach_reposicion.php';
		  break;	
		 case "Confirmar Reposicion":
	      // echo "aqui detalle 34";
	       $_SESSION['continuar'] = 2;
	       $_SESSION['detalle'] = 2;
	    //   $_SESSION['menu'] = 7;
		   //$_SESSION['continuar'] = 2;
		  require 'cjach_repos.php';
		  break;	 
		case "Reponer Caja Chica":
		    $_SESSION['continuar'] = 0;
		     $_SESSION['detalle'] = 1;
	         require 'cjach_repos.php';
		  break;	
		   case "Confirmar Solicitud Reposicion":
	      // echo "aqui detalle 34";
	     //  $_SESSION['continuar'] = 3;
	      // $_SESSION['detalle'] = 2;
	    //   $_SESSION['menu'] = 7;
		   //$_SESSION['continuar'] = 2;
		  require 'cjach_repos_imp.php';
		  break;	
		  	  		  
	  case "Detalle Gasto":
	   $_SESSION["menu"] = 1;
       require 'cjach_det_rev.php';
	   break;  
	   case "Revertir Gasto":
     
	       require 'cjach_rev.php';
           break; 
