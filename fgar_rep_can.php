...
<title>Reporte Detalle Fondo Creditos</title>
<meta charset="UTF-8">
...
<script type="text/javascript" src="js/reportes_fondo_cred_impr.js"></script> 
<script type="text/javascript" src="js/reportes_fondo_mant_cierre.js"></script> 
</head>
<body>	
...
<!--Menu izquierdo de los modulos-->
     <ul id="lista_menu">      
                ...
                if($_GET["menu"]==2){?> 
                 ...
                 <li id="menu_modulo_reportes_fondo_cred">
                 ...
                 <li id="menu_modulo_fecha">
                     ...
                     <img src="img/print_32x32.png" border="0" alt="Modulo" align="absmiddle"> IMPR. FON. CRED. CAN.
                    
                 </li>
              </ul> 
             
     <div id="contenido_modulo">
                      <h2> <img src="img/print_64x64.png" border="0" alt="Modulo" align="absmiddle">IMPRIMIR DETALLE FONDO DE GARANTIA CON CREDITOS CANCELADOS</h2>
              ...
              <?php } elseif($_GET["menu"]==1){?> 
                 ...
                 <li id="menu_modulo_fecha">
                     ...
                     <img src="img/documents_32x32.png" border="0" alt="Modulo" align="absmiddle"> REP. CIERR. SAL. MIN.
                    
                 </li>
              </ul> 
             
     <div id="contenido_modulo">
                      <h2> <img src="img/documents_64x64.png" border="0" alt="Modulo" align="absmiddle">REPORTE CIERRE DE CUENTAS SALDOS MINIMOS</h2>
                      <hr style="border:1px dashed #767676;">
                      <div id="error_login"> 
                     <img src="img/alert_32x32.png" align="absmiddle">
                     Ingrese la fecha de vencimiento
...
?>
  <div id="div_impresora" class="div_impresora" style="width:860px" align="right">
	   ...
	   <!--a href='fgar_cuentas.php'>Salir</a-->
  </div>
...
if ($cod_mon == 1){
 ...
 <?php
    $con_fon  = "Select DISTINCT FOND_NRO_CTA,FOND_TIPO_OPER From fond_maestro where FOND_COD_MON = $cod_mon 
	             and FOND_ESTADO = 3 and FOND_NRO_CTA > 1 and FOND_TIPO_OPER = 1 and
...
// echo "A leer el temp_fondo";
	  ...
	  $tot_sal = 0;
	  $_SESSION['grupo'] = 0;
      $con_tfon  = "Select * From temp_fondo where TEMP_SAL <= '$impo' and  TEMP_CRED = ' ' order by 3";
