...
<html>
<head>
<title>Consulta Fondo de Garantia Transaccion</title>
<link href="css/estilo.css" rel="stylesheet" type="text/css">
<link href="css/calendar.css" rel="stylesheet" type="text/css">
<script language="JavaScript" src="script/calendar_us.js"></script>
<script language="javascript" src="script/validarForm.js"></script> 
<script type="text/javascript" src="script/jquery-1.9.0.js"></script> 
<script type="text/javascript" src="js/fondo_dr_nombre_modif.js"></script>  
</head>
<body>
<?php
				include("header.php");
...
*/
$con_cli  = "Select * From cart_maestro, fond_maestro where CART_COD_GRUPO = $cod_gru 
             and FOND_NRO_CRED = CART_NRO_CRED  and
			 FOND_ESTADO = 3 and CART_ESTADO < 9 and 
			 CART_TIPO_OPER <> 2 
...
$res_cli = mysql_query($con_cli);
 ...
 <?php
   echo "Grupo".encadenar(3).$nom_com.$cod_gru;
 ...
 <table width="50%"  border="0" cellspacing="1" cellpadding="1" align="center">
    <tr>
      ...
      <th width="25%" scope="col"><border="0" alt="" align="absmiddle" />TITULAR/COORDINADORA</th>
 ...
 //    echo "Nro. Cuenta Fondo Garantia".encadenar(3).$_SESSION['cta_fon'];
          $cod_ncre = $lin_cli['CART_NRO_CRED'];
	  	...
	  	?>
		       <?php if ($t_prod == 1){ ?>
				 ...
				 <?php if ($t_prod == 2){ ?>
					...
					<td><INPUT NAME="ncre" TYPE=RADIO VALUE="<?php $cod_cta."*".$cod_ncre; ?>"></td>  
					<?php }?>
					<?php if ($t_prod == 3){ ?>
