...
<?php
if ($mone == 1){
    echo encadenar(45)."LISTADO DE OPERACIONES HISTORICO EN ".encadenar(2). "BOLIVIANOS";
  }
 if ($mone == 2){
    echo encadenar(45)."LISTADO DE OPERACIONES HISTORICO EN ".encadenar(2). "DOLARES";
  } 
?>
</font>
<br>
...
<font size="0"  style="" >
	...
	<tr>
	    <th align="center"><font size="-1">FECHA DESEM </th> 
		...
		<th align="center"><font size="-1">CAPITAL DESEM</th>
		<th align="center"><font size="-1">TIP.CRED</th>
	...
	*/	
	$p_cap = 0;
			...
			$con_car  = "Select * From cart_maestro, cart_deudor, cliente_general
             where (CART_FEC_DES between '$f_des2' and '$f_has2') and  
			  CART_DEU_NCRED = CART_NRO_CRED
             ...
             while ($lin_car = mysql_fetch_array($res_car)) {
					...
					$fec_des = $lin_car['CART_FEC_DES'];
					$p_cap = $lin_car['CART_IMPORTE'];
					$esta = $lin_car['CART_ESTADO'];
			...
			$f_pag = cambiaf_a_normal($fec_des);        
	...
	<tr>
	    ...
	    <td align="right" ><?php echo number_format($p_cap, 2, '.',','); ?></td>
	 	<td align="right" ><?php echo number_format($tcred, 0, '.',','); ?></td>
		<td align="right" ><?php echo number_format($esta, 0, '.',','); ?></td>
