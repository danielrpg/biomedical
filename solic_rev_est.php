...
<div id="pagina_sistema">
        ...
        <ul id="lista_menu">      
                 ...
                 <li id="menu_modulo_creditos">
                  ...
                  <li id="menu_modulo_creditos_reversionestado">
                   ...
                   <li id="menu_modulo_fecha">
                     ...
                     <img src="img/delete user_32x32.png" border="0" alt="Modulo" align="absmiddle">REVERSION ESTADO
                    
                 </li>
              </ul>  
              <div id="contenido_modulo">
<h2> <img src="img/delete user_64x64.png" border="0" alt="Modulo" align="absmiddle"><strong>REVERSION ESTADO </strong> </h2>
...
?>
  ...
  <input class="btn_form" type="submit" name="accion" value="Revertir-Estado">
