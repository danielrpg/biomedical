...
<!--Cabecera del modulo con su alerta-->
                      <h2> <img src="img/flag green_64x64.png" border="0" alt="Modulo" align="absmiddle">TRANSACCION REVERTIDA DE BANCOS</h2>
...
$act_tabla  = "update caja_deposito set CAJA_DEP_USR_BAJA = '$logi',
                                        CAJA_DEP_FCH_HR_BAJA = '$hoy'
               where (CAJA_DEP_FECHA between '$f_tran' and '$f_tran') and
				 CAJA_DEP_TIPO = $tipo and
				 CAJA_DEP_NRO = $nro_tran  and
...
$act_tabla  = "update caja_transac set CAJA_TRAN_USR_BAJA = '$logi',
			   ...
			   and CAJA_TRAN_TIPO_OPE = 15 and CAJA_TRAN_NRO_CAR = $nro_tran";
$res_tabla = mysql_query($act_tabla) ;
