...
<html>
<head>
<title>Actualiza Numero Cuota Plan de Pago</title>
...
?> 
            ...
            <div id="TitleModulo">
            	 <img src="images/24x24/001_36.png" border="0" alt="Modulo">
                  Actualiza Numero Cuota Plan de Pago
            </div>
<div id="AtrasBoton">
...
$total = 0;
 ...
 <?php 
 $gru = "0"; 
$con_car  = "Select * From cart_maestro where CART_ESTADO < 9 and CART_NUMERICO > 2746 and CART_MAE_USR_BAJA is null order by 2"; 
$res_car = mysql_query($con_car);
   ...
   $con_fpa = "Select * From gral_param_super_int where GRAL_PAR_INT_GRP = 13 and GRAL_PAR_INT_COD = $f_pag";
	...
	$nro = 0;	
	$con_tra = "Select * From cart_plandp where CART_PLD_NCRE = $cod_cre order by 4 ";
    $res_tra = mysql_query($con_tra);
	    
	    while ($lin_tra = mysql_fetch_array($res_tra)) {
		    $fec_cta = $lin_tra['CART_PLD_FECHA'];
		    $nro = $nro + 1;
		    $consulta = "update cart_plandp set CART_PLD_CTA = $nro where  
                                           CART_PLD_NCRE = $cod_cre and
									       CART_PLD_FECHA = '$fec_cta'";
