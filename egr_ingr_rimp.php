...
//   echo "...".$quecom."---";
    ...
    $tran = substr($nro_tra,1,4);
  }			 
	echo $tipo."---". $tran;	
	$con_car  = "Select * from caja_ing_egre
             where caja_ingegr_fecha = '$fec1' and
			 caja_ingegr_tipo = $tipo and
			 caja_ingegr_corr = $tran
             and caja_ingegr_usr_baja is null"; 
             $res_car = mysql_query($con_car);
 
             while ($lin_car = mysql_fetch_array($res_car)) {
	                $_SESSION['descrip'] =  $lin_car['caja_ingegr_descrip'];
	               $descrip = $_SESSION['descrip'];
				   $importe = $lin_car['caja_ingegr_impo'];
				   $_SESSION['monto_t'] = $importe;
				   $_SESSION['egre_bs_sus'] = $lin_car['caja_ingegr_mon'];
	         }
...
$_SESSION['nitci'] =  $nitci;
 ...
 <div id="div_impresora" class="div_impresora" style="width:860px" align="right">
	   ...
	   <!--a href="reg_ingr_fac.php">Factura</a-->
        <a href='cja_reimpre.php?accion=7'>Salir</a>

       <?php //if($_SESSION['menu']==1){?>
	   
	   <?php //} elseif($_SESSION['menu']==2){?>
	    <!--a href='cja_reimpre.php?accion=8'>Salir</a-->
	   <?php // }?> 
...
//if ($_SESSION['detalle'] == 3){
 ...
 //  $descrip = $_SESSION['descrip'];
  ...
  //$nro_tr_ingegr = leer_nro_co_ingegr(1);  
   ...
   //echo $_SESSION['egre_bs_sus'], $_SESSION['monto_eq'],$_SESSION['monto_t'];
   //echo $_SESSION['egre_bs_sus'],"--", $impo_sus,"---",$imp_or;
