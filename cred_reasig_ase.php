...
/*	if ($_SESSION['cart_fgar'] == 3){  
  ...
  <?php 
  echo  "Asesor Actual".encadenar(2).$nom_ases;
   ...
   $res_ase = mysql_query($con_ase)or die('No pudo seleccionarse tabla');
  
  ?>
  <br>			
	 <strong>Nuevo Asesor  </strong>
...
<?php // if ($_SESSION['cargo'] == 4){ ?>			
	 ...
	 <br><br>
	 <input type="submit" name="accion" value="Reasignar">
	   <?php  // }?> 
