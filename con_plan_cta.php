...
<!--script type="text/javascript" src="js/contabilidad_reportes_estado_bs.js"></script-->
<script type="text/javascript" src="js/contabilidad_mant_plan_consul.js"></script> 
...
<div id="dialog-confirm" title="Advertencia" style="display:none; ">
  <p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 20px 0;"></span><font size="2">Debe seleccionar una Cuenta Contable</font></p>
</div>
	<?php
...
<!--Menu izquierdo de los modulos-->
     <ul id="lista_menu">      
				...
				<div id="contenido_modulo">
                      ...
                      <h2> <img src="img/find_64x64.png" border="0" alt="Modulo" align="absmiddle"> CONSULTA PLAN DE CUENTAS</h2>
          ...
          <img src="img/alert_32x32.png" align="absmiddle">
				...
				<li id="menu_modulo_cont_reportes">
                  ...
                  <li id="menu_modulo_fecha">
                     ...
                     <img src="img/find_24x24.png" border="0" alt="Modulo" align="absmiddle"> EST. SITUACION BS/$US
        ...
        <?php }elseif ($_GET["menu"]==4) { $val=3; ?>
				<li id="menu_modulo_cont_reportes">
                  ...
                  <li id="menu_modulo_fecha">
                     ...
                     <img src="img/find_24x24.png" border="0" alt="Modulo" align="absmiddle"> EERR
...
if ($_SESSION['detalle'] == 1){ ?>
    <form name="form2" method="post" action="con_plancta.php?menu=<?php echo $val ?>" onSubmit="return checkCtas(this)">
<?php	
	...
	<center>	
		...
		<table>
    <tr><th align="left">Cuenta Contable :</th></tr>
    <tr> 
	  <td> <select name="cod_cta[]" size="5" style="width:500px; height:200px;" multiple>
           ...
           <option value=<?php echo $lin_cta['CONTA_CTA_NRO']; ?>>
		                 <?php echo $lin_cta['CONTA_CTA_NRO']; ?>
			              <?php echo utf8_encode(encadenar(2).$lin_cta['CONTA_CTA_DESC']); ?>
		   </option>
           <?php } ?>
		    </select>
			<br><br>	</td>
	 ...
	 <center>	
	 	 <tr><th><input class="btn_form" type="submit" name="accion" value="Consulta Plan Cta."></th></tr>
...
<form name="form2" method="post" action="con_retro_1.php" onSubmit="return">	
 <table width="100%"  border="1" cellspacing="1" cellpadding="1" align="center">
	...
	<center>
	 <input type="submit" name="accion" value="Retornar">
...
<table width="100%"  border="1" cellspacing="1" cellpadding="1" align="center">
 <tr>
	...
	<input type="submit" name="accion" value="Guardar Modificacion">
