...
$(document).on('ready', function(){
	...
	//modulo reportes fondo
	$('#menu_modulo_cajas_imp_des').click(function(){
		$(location).attr('href', 'cja_rimp_par.php?menu=9');
	});
	//modulo reportes fondo
	$('#menu_modulo_cajas_imp_des_sel').click(function(){
	$(location).attr('href', 'cja_des_rimp.php?menu=9');
	});
});