...
$(document).on('ready', function(){
	...
	$('#menu_modulo_cjas_cartera_directo_pornombre_cons_det').click(function(){
		$(location).attr('href', 'cliente_con_cobd.php?menu=13');
	});
	$('#menu_modulo_cjas_cartera_directo_pornombre_cons_det_imp').click(function(){
		$(location).attr('href', 'cart_imprime_p.php');
	});
});