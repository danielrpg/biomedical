...
$(document).on('ready', function(){
	...
	$('#menu_modulo_general_importaciones').click(function(){
		$(location).attr('href', 'modulo.php?modulo=30000');
	});
	$('#menu_modulo_almacen_proy').click(function(){
		$(location).attr('href', 'alm_proyecto.php');
	});
		$('#menu_modulo_general_importaciones_gestion').click(function(){
		$(location).attr('href', 'modulo.php?modulo=20000');
	});
	$('#menu_modulo_general_importaciones_contrato').click(function(){
		$(location).attr('href', 'alm_proyecto.php');
	});
