...
$(document).on('ready', function(){
	...
	$('#menu_modulo_fondo_dep_ret_nomgroup_modif').click(function(){
		$(location).attr('href', 'grupo_con_c.php?menu=1');
	});
	$('#menu_modulo_fondo_dep_ret_nomgroup_modif_impr').click(function(){
		$(location).attr('href', 'fgar_det_dere.php');
	});
});
