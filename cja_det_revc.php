...
?>
  <html>
<head>
<title>Detalle de Cobro a revertir</title>
<meta charset="UTF-8">
...
<script type="text/javascript" src="js/cajas_rev_cob_det.js"></script>  
</head>
<body>
<?php
				include("header.php");
...
<!--Menu izquierdo de los modulos-->
     <ul id="lista_menu">      
                 ...
                 <li id="menu_modulo_general_cajas">
                  ...
                  <li id="menu_modulo_cajas_rev_cob">
                 ...
                 <li id="menu_modulo_fecha">
                     ...
                     <img src="img/documents_32x32.png" border="0" alt="Modulo" align="absmiddle"> DETALLE COBROS
                    
                 </li>
              </ul> 
<!--Cabecera del modulo con su alerta-->
     <div id="contenido_modulo">
                      <h2> <img src="img/documents_64x64.png" border="0" alt="Modulo" align="absmiddle">DETALLE COBROS</h2>
...
//if ($mone == 1){
    ...
    echo encadenar(35)."DETALLE COBRO NRO. ".encadenar(3). $n_des;
 // }
// if ($mone == 2){
   ...
   // echo $f_des2.encadenar(2).$f_has2;
	...
	$con_tpa = "Select DISTINCT CART_DTRA_FECHA, CART_DTRA_NRO_TRAN, CART_DTRA_NCRE
	            ...
	            (CART_DTRA_FECHA between '$f_des' and '$f_des') and
	             ...
	             CART_DTRA_TIP_TRAN = 2 and  CART_NRO_CRED = CART_DTRA_NCRE 
	...
	<tr>
		...
		//echo $f_des2.encadenar(2).$f_has2.encadenar(2).$nro_tran.encadenar(2).$cod_cre;	
			...
			while ($lin_tra = mysql_fetch_array($res_tra)) { // 2 a
				  ...
				  $p_imp_e = $lin_tra['CART_DTRA_IMPO_BS'];
...
<center>
   <input type="submit" name="accion" value="Rev-Cobro">
